...
language_map = {
    'en': {
        ...
        'minutes': 'minutes',
        'never': 'never',
        'ServerRestarter.warning': 'The server is being restarted in $timeleft $timeunit.',
    ...
    'es': {
        ...
        'minutes': 'minutos',
        'never': 'nunca',
        'ServerRestarter.warning': 'El servidor se reiniciará en $timeleft $timeunit.',
        'ServerRestarter.restart': 'El servidor se reiniciará ahora.',
